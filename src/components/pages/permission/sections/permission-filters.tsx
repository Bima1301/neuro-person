...
interface PermissionFiltersProps {
	...
	onStatusFilterChange: (value: "PENDING" | "APPROVED" | "REJECTED" | "CANCELLED" | undefined) => void;
}
			...
			<CardContent className="pt-6">
				<div className="flex gap-4">
					...
					<Select
						...
						onValueChange={(v) =>
							onStatusFilterChange(v === "all" ? undefined : (v as "PENDING" | "APPROVED" | "REJECTED" | "CANCELLED"))
						}
					>
